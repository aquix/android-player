...
import com.example.vlad.player.views.dialogs.DeleteSongDialog;
import com.example.vlad.player.R;
import com.example.vlad.player.views.dialogs.SongInfoFragment;
...
import com.example.vlad.player.views.dialogs.OpenFileDialog;
...
public class PlaylistActivity extends ListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.db = new DbContext(this.getApplicationContext());

        // Initialize list
        this.songs = this.db.getSongsInPlaylist(this.playlistId);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (id == R.id.delete_song_item) {
            ...
            deleteDialog.setOnDeleteSongListener(this);
    ...
    public void onSelectedFile(String fileName) {
        ...
        this.db.addSong(song, this.playlistId);
        this.updateSongList();
        this.updateListView();
    }
